/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: cc86a38a2dba053a66c61b6e7ca6971e)
...
interface __BaseEnv_CloudflareEnv {
	...
	AI: Ai;
	ASSETS: Fetcher;
	CLOUDFLARE_AI_GATEWAY_ID: "shadcn-chatbot";
	CLOUDFLARE_ACCOUNT_ID: "d6ad0c67765f90322b4df2ff48b582b7";
	ASSETS_BUCKET_NAME: "shadcn-chatbot-assets";
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	RUNTIME_PROBE_WORKFLOW: Workflow /* RuntimeProbeWorkflow from shadcn-chatbot-workflows */;
	PLAN_EXECUTION_WORKFLOW: Workflow /* PlanExecutionWorkflow from shadcn-chatbot-workflows */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_AI_GATEWAY_ID" | "CLOUDFLARE_ACCOUNT_ID" | "ASSETS_BUCKET_NAME" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
